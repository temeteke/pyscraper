...
class WebFile():
    ...
    @retry((requests.exceptions.HTTPError, requests.exceptions.ConnectionError, requests.exceptions.ChunkedEncodingError, WebFileSizeError), tries=10, delay=2, backoff=2, jitter=(1, 5), logger=logger)
